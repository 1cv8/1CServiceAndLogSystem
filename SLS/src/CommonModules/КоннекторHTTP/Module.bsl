...
Функция ПараметрыПреобразованияJSONПоУмолчанию()
	...
	// Романов 22/12/22
	ПараметрыПреобразованияПоУмолчанию.Вставить("ИмяФункцииПреобразования", "ФункцияПреобразованияJSONЗначений");
	ПараметрыПреобразованияПоУмолчанию.Вставить("МодульФункцииПреобразования", ОбщегоНазначения.ОбщийМодуль("_ОбщиеФункцииHTTPСервисов"));
