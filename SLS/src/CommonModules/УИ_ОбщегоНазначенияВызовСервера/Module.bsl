...
//   - Соответствие 
//
Функция ПреобразоватьJSONВСоответствие(JSON) Экспорт
	
	МассивСвойствДат = Новый Массив;
	МассивСвойствДат.Добавить("created_at");
	МассивСвойствДат.Добавить("in_process_at");
	МассивСвойствДат.Добавить("updated_at");
	МассивСвойствДат.Добавить("operation_logistic_moment");

	Попытка
		ЧтениеJSON = Новый ЧтениеJSON; 
		ЧтениеJSON.УстановитьСтроку(JSON); 
		ДанныеJSON = ПрочитатьJSON(ЧтениеJSON, Истина,,, "ФункцияПреобразования", УИ_ОбщегоНазначенияВызовСервера,, МассивСвойствДат); 
		ЧтениеJSON.Закрыть();
	Исключение
		Комментарий = "Не удалось прочитать JSON: " + ПодробноеПредставлениеОшибки(ИнформацияОбОшибке());
		УИ_ОбщегоНазначенияКлиентСервер.СообщитьПользователю(Комментарий);
