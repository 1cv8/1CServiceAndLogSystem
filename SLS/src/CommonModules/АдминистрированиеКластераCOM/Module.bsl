...
Функция COMСоединитель() Экспорт // Романов 06/12/22
...
Функция СоединениеСАгентомСервера(COMСоединитель, Знач АдресАгентаСервера, Знач ПортАгентаСервера) Экспорт // Романов 06/12/22
...
Функция ПолучитьКластер(СоединениеСАгентомСервера, Знач ПортКластера, Знач ИмяАдминистратораКластера, Знач ПарольАдминистратораКластера) Экспорт // Романов 06/12/22
...
Функция СоединенияСРабочимиПроцессами(COMСоединитель, СоединениеСАгентомСервера, Кластер) Экспорт // Романов 06/12/22
...
// Романов 06/12/22 Добавил функцию
Функция ОписаниеБазКластера(СоединениеСАгентомСервера, Кластер) Экспорт
	
	ОписаниеБаз = Новый Массив;
	
	Для Каждого ОписаниеИнформационнойБазы Из СоединениеСАгентомСервера.GetInfoBases(Кластер) Цикл
		ОписаниеБаз.Добавить(ОписаниеИнформационнойБазы.Name);
	КонецЦикла;
