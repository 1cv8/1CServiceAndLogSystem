...
Функция СрезМассива(МассивЭлементов, НомерЗапроса, МаксимальноеКоличествоЭлементов = 1000)Экспорт
...
Функция СериализоватьЗапросДляОтладки(ОбъектОтладки)
	...
	Если ОбъектОтладки.МенеджерВременныхТаблиц <> Неопределено Тогда
		...
		Для Каждого ТаблицаВТ Из ОбъектОтладки.МенеджерВременныхТаблиц.Таблицы Цикл
...
Функция СериализоватьСКДДляОтладки(СКД, НастройкиСКД)
	Возврат УИ_ОбщегоНазначенияВызовСервера.СериализоватьОбъектСКДДляОтладки(СКД, НастройкиСКД);
КонецФункции
...
Функция СериализоватьОбъектДляОтладкиВСтруктуру(ОбъектОтладки, НастройкиСКДИлиСоединениеHTTP)
	...
	ИначеЕсли ТипЗнч(ОбъектОтладки) = Тип("СхемаКомпоновкиДанных") Тогда
		СтруктураОбъекта = СериализоватьСКДДляОтладки(ОбъектОтладки, НастройкиСКДИлиСоединениеHTTP);
	КонецЕсли;

	Возврат СтруктураОбъекта;
КонецФункции

Функция ОтладитьОбъект(ОбъектДляОтладки, НастройкиСКДИлиСоединениеHTTP = Неопределено) Экспорт
...
#КонецЕсли
	...
	ТипВсеСсылки = УИ_ОбщегоНазначенияПовтИсп.ОписаниеТипаВсеСсылки();
	СериализованныйОбъект = СериализоватьОбъектДляОтладкиВСтруктуру(ОбъектДляОтладки, НастройкиСКДИлиСоединениеHTTP);
